...
class BenefitsApi
{
    ...
    {
        list($response) = $this->benefitsCreateWithHttpInfo($x_account_token, $run_async, $benefit_request);
        return $response;
    }

    /**
     * Operation benefitsCreateWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  bool $run_async Whether or not third-party updates should be run asynchronously. (optional)
     ...
     */
    public function benefitsCreateAsync($x_account_token, $run_async = null, $benefit_request = null)
    {
        return $this->benefitsCreateAsyncWithHttpInfo($x_account_token, $run_async, $benefit_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation benefitsCreateAsyncWithHttpInfo
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  bool $run_async Whether or not third-party updates should be run asynchronously. (optional)
     * @param  \OpenAPI\Client\Model\BenefitRequest $benefit_request (optional)
    ...
    /**
     * Create request for operation 'benefitsCreate'
     *
     * @param  string $x_account_token Token identifying the end user. (required)
     * @param  bool $run_async Whether or not third-party updates should be run asynchronously. (optional)
     * @param  \OpenAPI\Client\Model\BenefitRequest $benefit_request (optional)
     ...
     */
    public function benefitsCreateRequest($x_account_token, $run_async = null, $benefit_request = null)
    {
        // verify the required parameter 'x_account_token' is set
        if ($x_account_token === null || (is_array($x_account_token) && count($x_account_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_account_token when calling benefitsCreate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($benefit_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($benefit_request));
            } else {
                $httpBody = $benefit_request;
            }
