...
class EmployeePayrollRunsApi
{
    ...
    public function employeePayrollRunsListWithHttpInfo($x_account_token, $created_after = null, $created_before = null, $cursor = null, $employee_id = null, $ended_after = null, $ended_before = null, $expand = null, $include_remote_data = null, $modified_after = null, $modified_before = null, $page_size = null, $payroll_run_id = null, $remote_id = null, $started_after = null, $started_before = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PaginatedEmployeePayrollRunList' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PaginatedEmployeePayrollRunList', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PaginatedEmployeePayrollRunList',
    ...
    public function employeePayrollRunsRetrieveWithHttpInfo($x_account_token, $id, $expand = null, $include_remote_data = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\EmployeePayrollRun' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\EmployeePayrollRun', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\EmployeePayrollRun',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
