...
/**
 * RemoteFieldAPIResponse Class Doc Comment
 *
 * @category Class
 * @package  MergeHRISClient
 * @author   OpenAPI Generator team
 ...
 */
class RemoteFieldAPIResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoteFieldAPIResponse';
    ...
    protected static $openAPITypes = [
        'benefit' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'employer_benefit' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'company' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'employee_payroll_run' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'employee' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'employment' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'location' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'payroll_run' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'team' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'time_off' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'time_off_balance' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'bank_info' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'pay_group' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'group' => '\MergeHRISClient\Model\RemoteFieldAPI[]',
        'dependent' => '\MergeHRISClient\Model\RemoteFieldAPI[]'
    ];
     ...
     * Gets benefit
     *
     * @return \MergeHRISClient\Model\RemoteFieldAPI[]|null
     */
     ...
     * Sets benefit
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $benefit benefit
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $employer_benefit employer_benefit
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $company company
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $employee_payroll_run employee_payroll_run
     *
     * @return self
     */
     ...
     * Sets employee
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $employee employee
     *
     * @return self
     */
     ...
     * Sets employment
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $employment employment
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $location location
     *
     * @return self
     */
     ...
     * Sets payroll_run
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $payroll_run payroll_run
     *
     * @return self
     */
     ...
     * Sets team
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $team team
     *
     * @return self
     */
     ...
     * Sets time_off
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $time_off time_off
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $time_off_balance time_off_balance
     *
     * @return self
     */
     ...
     * Sets bank_info
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $bank_info bank_info
     *
     * @return self
     */
     ...
     * Sets pay_group
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $pay_group pay_group
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $group group
     *
     * @return self
     */
     ...
     * Sets dependent
     *
     * @param \MergeHRISClient\Model\RemoteFieldAPI[]|null $dependent dependent
     *
     * @return self
     */
