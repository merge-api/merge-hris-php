...
/**
 * FieldMappingApiInstanceResponse Class Doc Comment
 *
 * @category Class
 * @package  MergeHRISClient
 * @author   OpenAPI Generator team
 ...
 */
class FieldMappingApiInstanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FieldMappingApiInstanceResponse';
    ...
    protected static $openAPITypes = [
        'benefit' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'employer_benefit' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'company' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'employee_payroll_run' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'employee' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'employment' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'location' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'payroll_run' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'team' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'time_off' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'time_off_balance' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'bank_info' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'pay_group' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'group' => '\MergeHRISClient\Model\FieldMappingApiInstance[]',
        'dependent' => '\MergeHRISClient\Model\FieldMappingApiInstance[]'
    ];
     ...
     * Gets benefit
     *
     * @return \MergeHRISClient\Model\FieldMappingApiInstance[]|null
     */
     ...
     * Sets benefit
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $benefit benefit
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $employer_benefit employer_benefit
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $company company
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $employee_payroll_run employee_payroll_run
     *
     * @return self
     */
     ...
     * Sets employee
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $employee employee
     *
     * @return self
     */
     ...
     * Sets employment
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $employment employment
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $location location
     *
     * @return self
     */
     ...
     * Sets payroll_run
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $payroll_run payroll_run
     *
     * @return self
     */
     ...
     * Sets team
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $team team
     *
     * @return self
     */
     ...
     * Sets time_off
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $time_off time_off
     *
     * @return self
     */
     ...
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $time_off_balance time_off_balance
     *
     * @return self
     */
     ...
     * Sets bank_info
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $bank_info bank_info
     *
     * @return self
     */
     ...
     * Sets pay_group
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $pay_group pay_group
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $group group
     *
     * @return self
     */
     ...
     * Sets dependent
     *
     * @param \MergeHRISClient\Model\FieldMappingApiInstance[]|null $dependent dependent
     *
     * @return self
     */
